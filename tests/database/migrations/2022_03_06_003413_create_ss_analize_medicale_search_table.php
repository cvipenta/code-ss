...
class CreateSsAnalizeMedicaleSearchTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ss_analize_medicale_search', function (Blueprint $table) {
            $table->integer('s_id')->index('s_id');
            $table->string('s_string', 100)->default('')->unique('s_string');
    ...
    {
        Schema::dropIfExists('ss_analize_medicale_search');
    }
}
