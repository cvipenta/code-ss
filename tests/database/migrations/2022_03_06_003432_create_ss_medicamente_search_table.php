...
class CreateSsMedicamenteSearchTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ss_medicamente_search', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ss_medicamente_search');
    }
}
