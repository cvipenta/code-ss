...
class CreateSsDictionarSearchSuggestTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ss_dictionar_search_suggest', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ss_dictionar_search_suggest');
    }
}
