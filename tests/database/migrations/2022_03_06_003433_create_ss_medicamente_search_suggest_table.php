...
class CreateSsMedicamenteSearchSuggestTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ss_medicamente_search_suggest', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ss_medicamente_search_suggest');
    }
}
